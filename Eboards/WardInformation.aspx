...
<%--END LICENSE BLOCK--%> 
﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WardInformation.aspx.cs" Inherits="EBoards.WardInformation" %>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <%--<li class="nav-item tabbedButton">
                            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="nav-link" OnClick="lbtnNavCurrentPatients_Click">
                                <asp:Label runat="server" ID="Label1" Text="Current Patients"></asp:Label>
                                &nbsp;
                            <asp:Label runat="server" ID="Label2" Text="0" CssClass="badge badge-info" Visible="false"></asp:Label>
                                &nbsp;&nbsp
                            </asp:LinkButton>
                        </li>
                        <li class="nav-item tabbedButton">
                            <asp:LinkButton ID="LinkButton2" runat="server" CssClass="nav-link" OnClick="lbtnNavTCIs_Click">
                                <asp:Label runat="server" ID="Label3" Text="Patients to come in"></asp:Label>
                                &nbsp;
                            <asp:Label runat="server" ID="Label4" Text="0" CssClass="badge badge-info" Visible="false"></asp:Label>
                                &nbsp;&nbsp
                            </asp:LinkButton>
                        </li>--%>
                        <li class="nav-item tabbedButton">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <asp:TextBox ID="txtWardInformation" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="10">
                    </asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <asp:LinkButton id="btnSave" runat="server" CssClass="btn btn-success float-right" OnClick="btnSave_Click"><i class="fa fa-thumbs-up"></i>&nbsp;Okay, Save Ward information</asp:LinkButton>
                </div>
            </div>
