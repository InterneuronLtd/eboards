...
namespace EBoards
{
    public partial class DynamicBedBoard : System.Web.UI.Page
    {
        ...
        {
            String ipAddress = this.lblIPAddress.Text;

            String sql = "SELECT * FROM eboards.v_bedboarddevice WHERE deviceipaddress = @deviceipaddress;";
            ...
            try
            {
                BedBoardID = dt.Rows[0]["bedboard_id"].ToString();
            }
            catch
            {
            ...
            try
            {
                Ward = dt.Rows[0]["wardlocationcode"].ToString();
            }
            catch
            {
                //Response.Redirect("Error.aspx");
            ...
            try
            {
                Bed = dt.Rows[0]["baybedcode"].ToString();
            }
            catch
            {
                //Response.Redirect("Error.aspx");
        ...
        private void GetBedBoardDetails()
        {
            ...
            if(String.IsNullOrEmpty(baseviewname)) {
                //StringBuilder sbe = new StringBuilder();
                //sbe.AppendLine("<div class='contentAlertDanger'><h3 style='color: #712f2f'>Unable to load Bed Board:</h3>");
                //sbe.AppendLine("</div>");
                return;
            }
