        ...
        function SetActiveTab() {
            ...
            switch (currentPage) {
                case "Current Patients":
                    ...
                    break;
                case "Waiting for a bed":
                    $("#lbtnNavWaitingArea").addClass("linkActive");
                    break;
                case "Patients to come in":
                    ...
                    <div class="col-md-2">
                        <div>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <strong class="text-sm-left text-dark">Enable handover mode:                                
                                        </strong>
                                    </td>
                            ...
                            <div class="alert alert-danger" id="divHandoverEnabled">
                                <span class="text-sm-left">
                                    <i class="fa fa-bell"></i>Refresh is disabled
                                </span>
                                <br />
                                <span style="font-style: italic; font-size: 0.6em;" id="refreshMinutes"></span>
                            </div>

                            <div class="alert alert-success" id="divHandoverDisabled">
                                <span class="text-sm-left">
                                    <i class="fa fa-check"></i>Refresh is enabled
                                </span>
                            </div>
